...
## 機能紹介
LINEログイン認証で簡単に会員登録し、
活動を開始する際「チェックイン」、完了するときは「チェックアウト」するだけです。
マイページからいつでも活動時間の記録が見られます。
また、チェックアウトする前に「気分チェッカー」と「気分メモ」を任意で保存できます。
その日の気分を記録しておき、後日、マイページにある記録を振り返れます。
パートナー（観葉植物）がユーザーをcheer upすることに重点をおき、
少しでもユーザーを労われたらと願いを込めました。
